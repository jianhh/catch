...
public class ALiBaBa {
	...
	private static JLogger logger = LoggerFactory.getLogger(ALiBaBa.class);
	...
	private static String loginUrl = "http://login.1688.com/member/signin.htm?spm=a260k.635.1998491066.3.dphbhw&Done=http%3A%2F%2Fwww.1688.com%2F";
	 ...
	 * @param passWord
	 */
	public ALiBaBa(String userName, String passWord) {
	...
	public static void main(String[] args) throws IOException {
		...
		ALiBaBa tb = new ALiBaBa("tangbiao891022", "tangbiao_131130");
	...
	public Integer login(String code) {
		...
		try {
			...
			LogUtil.writeUserloginLog("userName:" + userName + " post返回状态："
	...
	public Integer loginCode(String loginUrl, String target, String checkCode) {
		...
		try {
			...
			try {
				...
				if (companyEle != null) {
					String href = companyEle.attr("href");
					LogUtil.writeUserloginLog("userName:" + userName + " 阿里域名："
							+ href);
					if (StringUtils.isNotEmpty(href)) {
						String url = href
								.substring(href.indexOf(".com:80") + 7);
						if (url.length() == 0) {
							sellerUrl = href;
							return 0;
						}
